...
describe('Alert', function() {
  ...
  it('will display the title that is provided', function () {
    ...
    expect(ReactDOM.findDOMNode(subject.refs.title).lastChild.firstChild.nodeValue).to.equal(title);
  });
  ...
  it('will display the body that is provided', function () {
    ...
    expect(ReactDOM.findDOMNode(subject.refs.body).firstChild.nodeValue).to.equal(body);
  });
  ...
  describe("Icon", function(){
    it("will not display an icon if it isn't told to", function(){
      ...
      expect(ReactDOM.findDOMNode(subject.refs.title).firstChild.className.indexOf(alertIconClass)).to.equal(-1);
    });
    ...
    it('will display an icon if it is told to', function(){
      ...
      expect(ReactDOM.findDOMNode(subject.refs.title).firstChild.className.indexOf(alertIconClass)).to.above(-1);
    });
    ...
    describe("Type", function(){
      ...
      it('will display the correct icon for default', function(){
        ...
        expect(ReactDOM.findDOMNode(subject.refs.title).firstChild.className.indexOf(defaultIconClass)).to.above(-1);
      });
      ...
      it('will display the correct icon for warning', function(){
        ...
        expect(ReactDOM.findDOMNode(subject.refs.title).firstChild.className.indexOf(warningIconClass)).to.above(-1);
      });
      ...
      it('will display the correct icon for success', function(){
        ...
        expect(ReactDOM.findDOMNode(subject.refs.title).firstChild.className.indexOf(successIconClass)).to.above(-1);
      });
      ...
      it('will display the correct icon for error', function(){
        ...
        expect(ReactDOM.findDOMNode(subject.refs.title).firstChild.className.indexOf(errorIconClass)).to.above(-1);
      });
    });
  });
  ...
  describe("Closeable", function(){
    ...
    it('will close if it is closeable and the close action is clicked', function(){
      const subject = TestUtils.renderIntoDocument(<Alert type="error" title={title} body={body} closeable={true} />);
      const close = ReactDOM.findDOMNode(subject.refs.close);
